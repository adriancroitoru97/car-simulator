    ...
    class Camera
    {
     public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            forward = glm::normalize(rotationMatrix * glm::vec4(forward, 0));
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // vectors!
            glm::mat4 rotationMatrix = glm::rotate(glm::mat4(1), angle, { 0, 1, 0 });
            forward = glm::normalize(rotationMatrix * glm::vec4(forward, 0));
            right = glm::normalize(rotationMatrix * glm::vec4(right, 0));
            up = glm::cross(right, forward);
        }
