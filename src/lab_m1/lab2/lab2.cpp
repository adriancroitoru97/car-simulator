...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(3, -1,  1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(-1, 3,  1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(3, 3,  1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(-1, -1,  5), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(3, -1,  5), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(-1, 3,  5), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(3, 3,  5), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)) 
        };
    ...
    // by definition!
    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0.3, 0.7, 1)),
            VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0.8, 0.1, 0.2)),
            VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0.17, 0.37, 0.9)),

            VertexFormat(glm::vec3(4, 0,  0), glm::vec3(0.3, 0.7, 1)),
            VertexFormat(glm::vec3(4, 0,  0), glm::vec3(0.8, 0.1, 0.2)),
            VertexFormat(glm::vec3(4, 0,  0), glm::vec3(0.23, 0.7, 0.4)),

            VertexFormat(glm::vec3(2, 3.4641f,  0), glm::vec3(0.3, 0.7, 1)),
            VertexFormat(glm::vec3(2, 3.4641f,  0), glm::vec3(0.17, 0.37, 0.9)),
            VertexFormat(glm::vec3(2, 3.4641f,  0), glm::vec3(0.23, 0.7, 0.4)),

            VertexFormat(glm::vec3(2, 1.1547f,  3.26599f), glm::vec3(0.8, 0.1, 0.2)),
            VertexFormat(glm::vec3(2, 1.1547f,  3.26599f), glm::vec3(0.17, 0.37, 0.9)),
            VertexFormat(glm::vec3(2, 1.1547f,  3.26599f), glm::vec3(0.23, 0.7, 0.4))
        };
        ...
        // Actually create the mesh from the data
        CreateMesh("tethraedron", vertices, indices);
    }
    ...
    // opposing vertex orientations.
    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0.5, 0.1, 0.6), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 0,  5), glm::vec3(0.5, 0.1, 0.6), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 5,  0), glm::vec3(0.5, 0.1, 0.6), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 5,  5), glm::vec3(0.5, 0.1, 0.6), glm::vec3(0.2, 0.8, 0.6)),
        };
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(-3, 2, 1), glm::vec3(0.25f));
    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tethraedron"], shaders["VertexColor"], glm::vec3(2, 2, 3), glm::vec3(0.25f));
    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(2, 1, 1), glm::vec3(0.25f));
